...

{
    ...
    public void initialize(SEResourceCache rsc)
     ...
     {
        base.initialize(rsc);
        bg = add_sprite_for_color(Color.instance("#800000"),get_scene_width(),get_scene_height());
        bg.move(0,0);
        //fg = add_sprite_for_color(Color.instance("#000000"),get_scene_width()*0.1, get_scene_height()*0.1);
        //fg.move(100,100);
        rsc.prepare_font("myfont", "tahoma color=white", 50);
        ...
        rsc.prepare_image("myimage", "AWESOME_FACE!!!", get_scene_width()*0.15);
